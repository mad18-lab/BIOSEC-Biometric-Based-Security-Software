...
public class MainActivity extends AppCompatActivity {
    Button googleAuth;      //button for login
    FirebaseAuth mAuth;     //class for authenticating using Firebase
    FirebaseDatabase database;  //class for adding Firebase database utilities
    GoogleSignInClient googleSignInClient;  //class for implementing Google Sign-In Client
    int RC_SIGN_IN = 20;
    @Override
